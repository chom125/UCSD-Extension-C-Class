#ifndef C2A5E4_STATUSCODE_DRIVER_H
#define C2A5E4_STATUSCODE_DRIVER_H
...
// The following enum defines the status codes returned by the
// DetectFloats function.
enum StatusCode { NOTFLOATING, TYPE_FLOAT, TYPE_DOUBLE, TYPE_LDOUBLE };
